...
// Save XML (optional)
const xmlOutputPath = path.join(__dirname, '../extracted-data/style_extracted.xml');
...
// Save JSON
const jsonOutputPath = path.join(__dirname, '../extracted-data/style_extracted.json');
